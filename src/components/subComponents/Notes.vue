    ...
    const defaultData = [
      {
        ...
        value:
          "Hmmm... There should be hackathon that tackles the problem of inefficient \
          data visualisation of Covid-19 vaccinations in the Netherlands ",
      },
      {
        done: false,
        value: "Or... A drone-hackathon!",
      },
    ];
...
.mainbutton:hover {
  ...
  border-radius: 5px;
  cursor: pointer;
  box-shadow: 0 0 5px #ceb3ff, 0 0 25px #ceb3ff, 0 0 50px #ceb3ff,
    0 0 100px #ceb3ff;
}
